(function(k,f,v){"object"===typeof exports?exports=f(exports,"undefined"!==typeof window?window:"undefined"!==typeof global?global:{}):"function"===typeof define?define(function(){return f({},k)}):k.Keys=f(k.Keys,window)})(this,function(k,f,v){function w(){for(var a=Array.prototype.slice.call(arguments),b=0;b<a.length;b++)if(null!==a[b]&&"undefined"===typeof a[b])return!1;return!0}function x(a,b,d){(!d||k.debug)&&a.slice().forEach(function(a){b.call(null,a)});return a}function y(a){var b=Array.prototype.slice.call(arguments,
1);return a.map(function(a,e){for(var c=[],h=0;h<b.length;h++){var s=b[h]&&b[h][e];c.push(null!==s&&"undefined"!==typeof s?s:null)}return[a].concat(c)})}function m(a,b){for(var d=0;d<a.length;d++)if(b(a[d]))return a[d];return null}function c(a,b){this.name=a;this.code=b;c.internals.keymap[a]=c.internals.keymap[a]||b}function g(a,b){function d(a,b){return null!==m(a,function(a){return b.eq(a)})}var e=null;if(2===arguments.length&&b instanceof Array)e=b;else if(2<=arguments.length)e=Array.prototype.slice.call(arguments,
...
e||-1)*Math.floor(Math.abs(e))));if(e>=d)return-1;for(e=0<=e?e:Math.max(d-Math.abs(e),0);e<d;e++)if(e in b&&b[e]===a)return e;return-1});var n=function(){var a=console?u.call(console.log,console):Function.prototype.valueOf();return function(){if(k.debug){var b=Array.prototype.slice.call(arguments);a.apply(null,b)}}}(),p=function(){var a=console?u.call(console.warn,console):Function.prototype.valueOf();return function(){var b=Array.prototype.slice.call(arguments);a.apply(null,b)}}();c.internals={};
...
function(a){function b(b){var d;if(d=b.eventType===a.type){if(!(b=b.isGlobal))a.target&&a.target.nodeName?(b=a.target.nodeName.toLowerCase(),b=-1===["input"===b,"textarea"===b,"select"===b].indexOf(!0)):b=!0;d=b}return d}function d(a){n("Bindings.handleEvent called for Combo: "+c.toString()+". Handler `"+a.name+"` was called.")}function e(a){a.handler.call(null)}var c=g.fromEvent(a);if(c){var h=this.getHandlersForCombo(c).filter(b);x(h,d,!0);h.forEach(e)}};l.prototype.enable=function(){var a=this,
b=Array.prototype.slice.call(arguments);b.length?b.forEach(function(b){b&&"string"===typeof b&&a.bindings.forEach(function(a){a.name===b&&(a.enabled=!0)})}):(b=this.onInputEvent.bind(this),"undefined"!==typeof f.document.addEventListener?(f.document.addEventListener("keydown",b,!1),f.document.addEventListener("keyup",b,!1),f.document.addEventListener("keypress",b,!1)):(f.document.attachEvent("onkeydown",b),f.document.attachEvent("onkeyup",b),f.document.attachEvent("onkeypress",b)),this.bindings.forEach(function(a){a.enabled=
!0}))};l.prototype.disable=function(){var a=this,b=Array.prototype.slice.call(arguments);b.length?b.forEach(function(b){b&&"string"===typeof b&&a.bindings.forEach(function(a){a.name===b&&(a.enabled=!1)})}):(b=this.onInputEvent.bind(this),"undefined"!==typeof f.document.removeEventListener?(f.document.removeEventListener("keydown",b,!1),f.document.removeEventListener("keyup",b,!1),f.document.removeEventListener("keypress",b,!1)):(f.document.detachEvent("onkeydown",b),f.document.detachEvent("onkeyup",
b),f.document.detachEvent("onkeypress",b)),this.bindings.forEach(function(a){a.enabled=!1}))};l.prototype.get=function(a){return m(this.bindings,function(b){return b.name===a})};l.prototype.load=function(a){if(!a||!a.constructor||"Object"!==a.constructor.name)throw Error("Bindings.load: `specs` must be an object.");for(var b in a)if(Object.prototype.hasOwnProperty.call(a,b)){var d="Bindings.load: The specs object provided contains an invalid binding specification `"+b+"` - ";if(!a[b]||!a[b].constructor||
"Object"!==a[b].constructor.name)p(d+"invalid value type.");else{var e=b,r=a[b].description||"",h=a[b].bind,f=a[b].handler,k=a[b].eventType,l=a[b].isGlobal||!1;if(w(h,f)){var m;m=!f||"function"!==typeof f?!1:!0;m?h instanceof Array||h instanceof g||h instanceof c?(d=[e,r].concat(h),this.add.apply(this,d),k?this.registerHandler.call(this,e,k,f,l):this.registerHandler.call(this,e,f,l)):p(d+"bind must be an instance of Array, Combo, or Key"):p(d+"handler must be a function.")}else p(d+"requires definition of bind or handler.")}}};
l.prototype.add=function(a,b){var d=[],e=b&&"string"===typeof b?b:"",d=b&&"string"!==typeof b?Array.prototype.slice.call(arguments,1):Array.prototype.slice.call(arguments,2);if((e?3>arguments.length:2>arguments.length)||!a||!d.length)throw Error("Keybindings.add: Invalid arguments provided");d.forEach(function(a){if(!(a instanceof g||a instanceof c))throw Error("Keybindings.add: `combo` must be an instance of Key or Combo");});var f=m(this.bindings,function(b){return b.name===a});f?(e&&(f.description=
e),f.combos=d,n("Bindings.add: Updated existing binding - `"+a+"` with "+d.length+" combos")):(this.bindings.push({name:a,description:e,combos:d,enabled:!0}),n("Bindings.add: New binding - `"+a+"` with "+d.length+" combos"))};l.prototype.registerHandler=function(a,b,d,c){1===arguments.length&&"function"===typeof a&&(d=a,a=d.name,b="keydown");2===arguments.length&&"function"===typeof a?(d=a,a=d.name,c=b||!1,b="keydown"):2===arguments.length&&"function"===typeof b?"keyup"===a||"keydown"===a||"keypress"===
a?(d=b,b=a,a=d.name):(d=b,b="keydown"):3===arguments.length&&"function"===typeof b&&("keyup"===a||"keydown"===a||"keypress"===a?(c=d||!1,d=b,b=a,a=d.name):(c=d||!1,d=b,b="keydown"));if(!a||!b||!d||"function"!==typeof d)throw Error("Bindings.registerHandler: Invalid arguments provided");if("anonymous"===a)throw Error("Bindings.registerHandler: The function handler provided was anonymous when it needs to be named (in order to infer the binding name)");this.get(a)||p("Bindings.registerHandler: You have registered a handler for `"+
