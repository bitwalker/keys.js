...
b+"` - ";if(!a[b]||!a[b].constructor||"Object"!==a[b].constructor.name)p(d+"invalid value type.");else{var e=b,r=a[b].description||"",h=a[b].bind,f=a[b].handler,k=a[b].eventType,l=a[b].isGlobal||!1;if(w(h,f)){var m;m=!f||"function"!==typeof f?!1:!0;m?h instanceof Array||h instanceof g||h instanceof c?(d=[e,r].concat(h),this.add.apply(this,d),k?this.registerHandler.call(this,e,k,f,l):this.registerHandler.call(this,e,f,l)):p(d+"bind must be an instance of Array, Combo, or Key"):p(d+"handler must be a function.")}else p(d+
